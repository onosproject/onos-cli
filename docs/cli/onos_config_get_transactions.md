...
Get list of configuration transactions

```
onos config get transactions [transactionID] [flags]
```
...
```
  -h, --help         help for transactions
      --index uint   optional index for transaction lookup; takes precedence over ID
